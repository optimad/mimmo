...
void test0007() {
	...
	string filename = "mimmo_0007p.0000";
...
//	bend->setCoeffs(2,1,coeffs);
	...
	//Plot results
	lattice->plotGrid("./", "lattice_0007", 0, false, false);
	lattice->plotGrid("./", "lattice_0007", 1, false, true);
	filename = "mimmo_0007d.0001";
	mimmoDisk.m_geometry->setName(filename);
	mimmoDisk.m_geometry->write();

	filename = "mimmo_0007p.0001";
	mimmoPlane.m_geometry->setName(filename);
	mimmoPlane.m_geometry->write();
