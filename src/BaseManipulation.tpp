 ...
 * \param[in] label Label (type tag) of the port. The plurality of the same tag is not allowed.
 ...
 * \param[in] compatibilities Labels (type tags) compatible with the input port. The output ports
