 ...
 *	M_VIOLATION			= 82	 Port dedicated to communicate a double value, with string etiquette attached as std::pair<std::string, double>,
...
enum class dataTAG{
	...
	PAIRMIMMO_STRINGFLOAT_      /**< TAG related to a std::pair<std::string, double> data.*/,
