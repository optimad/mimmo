 ...
 * Default constructor.
 */
ExtractStringField::ExtractStringField():ExtractField(){
    m_name = "mimmo.ExtractStringField";
}
 ...
 */
ExtractStringField::ExtractStringField(const bitpit::Config::Section & rootXML){
    ...
    if(input_name == "mimmo.ExtractStringField"){
 ...
 */
ExtractStringField::ExtractStringField(const ExtractStringField & other):ExtractField(other){
 ...
 * \param[in] other class of type ExtractField
 */
ExtractStringField & ExtractStringField::operator=(const ExtractStringField & other){
...
/*!
 * Swap function of ExtractStringField
...
ExtractStringField::getExtractedField(){
    return &m_result;
}
 ...
 */
MimmoPiercedVector<std::string>
ExtractStringField::getOriginalField(){
    return m_field;
}
 ...
 */
void
ExtractStringField::setField(MimmoPiercedVector<std::string> *field){
    if(!field) return;
    m_field = *field;
}
 ...
 */
void
ExtractStringField::plotOptionalResults(){
 ...
 */
void ExtractStringField::extractID(mimmo::MPVLocation loc){
 ...
 * \param[in] loc MPVLocation enum identifying data location POINT, CELL or INTERFACE.
 */
void ExtractStringField::extractPID(mimmo::MPVLocation loc){
    //Extract by PIDs
 ...
 * \param[in] loc MPVLocation enum identifying data location POINT, CELL or INTERFACE.
 */
void ExtractStringField::extractMapping(mimmo::MPVLocation loc){
