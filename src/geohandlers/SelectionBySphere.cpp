 ...
 * - <B>Span</B>: span of the sphere (radius, azimuthal span(in radians), polar span(in radians))
 * - <B>RefSystem</B>: reference system of the sphere (z/2 is the pole/pole axis);
