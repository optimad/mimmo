 ...
 * \param[in] alpha Value of the maximum distance on the twist axis.
 */
void
 ...
 * BaseManipulation::absorbSectionXML.The class read essential parameters to perform twist
 ...
 */
void TwistGeometry::absorbSectionXML(const bitpit::Config::Section & slotXML, std::string name){
 ...
 * BaseManipulation::absorbSectionXML.The class read essential parameters to perform twist of a
 * geometry.Filter field, geometry and resulting displacements are passed mandatorily through ports
 * 
 * --> Flushing data// how to write it on XML:
 * - <B>ClassName</B>: name of the class as "mimmo.TwistGeometry"
 * - <B>Priority</B>: uint marking priority in multi-chain execution;	
 * - <B>Origin</B>: twist axis origin
 * - <B>Direction</B>: axis direction coordinates
 * - <B>Twist</B>: twist angle in radians. Positive on counterclockwise twists around reference axis
 ...
 * \param[in] name   name associated to the slot
 */
void TwistGeometry::flushSectionXML(bitpit::Config::Section & slotXML, std::string name){
